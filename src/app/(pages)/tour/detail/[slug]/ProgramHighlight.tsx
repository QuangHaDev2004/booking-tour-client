  ...
  return (
    <div className="mt-[30px] overflow-hidden rounded-lg bg-white p-4  sm:p-5 shadow-md">
      ...
      >
        ...
        đẹp cổ kính với kiếntrúc đặc trưng của Trung Hoa. Cố Cung Tử Cấm Thành
        biểu tượng bảo tàng cung điện lớn nhất thế giới Vạn Lý Trường Thành công
        trình kiến trúc lịch sử vĩ đại của nhân dân Trung Hoa, Thập Tam Lăng –
        Định Lăng địa cung lăng tẩm hoàng gia Minh – Thanh Di Hòa Viên Cung Điện
        Mùa Hè của Từ Hy Thái Hậu Phố Vương Phủ Tỉnh nơi hội tụ những điều xa
        hoa, lịch sử , văn hóa, ẩm thực tiêu biểu của Bắc Kinh niên đại hơn 1000
        năm. Phố Tiền Môn trung tâm giải trí nổi tiếng đầu tiên tại Bắc Kinh với
        lịch sử hơn 570 năm Chùa Phật Ngọc linh thiêng nổi tiếng nhất tại Thượng
        Hải đời Tống. Bến Thượng Hải ngắm tháp truyền hình Minh Châu ĐôngPhương
        Phố thương mại Nam Kinh, check-in bên ngoài tòa nhà Tòa nhà Louis
        Vuitton kiến trúc độc đáo. Chu Gia Giác thủy trấn đẹp như tranh giữa
        lòng Thượng Hải có niên đại hơn 1700 năm Miếu Thành Hoàng + TTTM Miếu
        Thành Hoàng phố cổThượng Hải sầm uất, vẫn giữ được nét đẹp cổ kính với
        kiếntrúc đặc trưng của Trung Hoa.
        {!expanded && (
