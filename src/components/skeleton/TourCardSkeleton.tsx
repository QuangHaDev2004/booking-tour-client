    ...
    <div className="overflow-hidden rounded-md bg-white shadow-md">
      ...
      <div className="mt-4 p-2.5">
        <div className="mb-2 space-y-1">
          ...
          <div className="mx-auto h-5 w-3/4 animate-pulse rounded-md bg-gray-200"></div>
        </div>
        ...
        <div className="flex h-10 items-center justify-between rounded-4xl border border-gray-300">
          <div className="ml-3 h-6 w-28 animate-pulse rounded-md bg-gray-200 font-semibold"></div>
          <div className="h-10 w-[105px] animate-pulse rounded-4xl bg-gray-200"></div>
        </div>
      </div>
    </div>
  );
